...
class FixedWingPositionControl(Node):
    ...
    def switch_to_offboard(self):
        ...
        # YENİ EKLE: Offboard'a geçtikten 10 saniye sonra çalışacak yeni zamanlayıcı
        self.timer_altitude = self.create_timer(10.0, self.switch_to_altitude)

    def switch_to_altitude(self): 
        self.get_logger().info('10 saniye doldu, ACRO (Akrobasi) moduna geçiliyor...')
    ...
    def state_callback(self, msg):
        # State mesajından güncel uçuş modunu alıp cebimize atıyoruz
